...
try {
	...
	if($method === "POST") {
		...
		$message = <<< EOF
<h2>Welcome to Deep Dive Tutor.</h2>
<p>In order to start using Deep Dive Tutor, you must confirm your account.</p>
...
EOF;
		...
		$swiftMessage->setFrom(["mbonacci@cnm.edu" => "mbonacci"]);
		/**
