...
export class ProfileComponent implements OnInit {
	...
	constructor( private profileService:ProfileService, private router:Router, private route:ActivatedRoute, protected cookieService: CookieService, protected sessionService: SessionService){}
